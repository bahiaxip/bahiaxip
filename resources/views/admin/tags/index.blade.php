        ...
        <div class="col-10 offset-1">
            <div class="panel panel-default">
                <div class="header">
                    ...
                    <a href="{{ route("tags.create") }}" class="btn btn-sm btn_pry float-right">
                        Crear
                    </a>
                </div>
            </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $tag->name }}</td>
                            <td with="10px">
                                <a href="{{ route("tags.show",$tag->id) }}" class="btn btn-sm btn_pry">
                                    Ver
                                </a>
                            </td>                            
                            <td with="10px">
                                <a href="{{ route("tags.edit",$tag->id) }}" class="btn btn-sm btn_sry">
                                    Editar
                                </a>
                            </td>
                            <td with="10px">

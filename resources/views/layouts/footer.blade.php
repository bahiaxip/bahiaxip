<div class="footer" >
    ...
    {{-- enlaces de política de cookies, aviso legal... --}}
    {{-- <div class="footer_links" >
        <a href="#" onclick="toggleModalCookies('show',event)">Configuración de cookies</a>
        <a href="#">Política de cookies</a>
        <a href="#">Aviso legal</a>
    </div> --}}
    <div class="div_textfooter" >
        <div class="textfooter" >
            <p>
                Desarrollado por <a href="{{config('app.url')}}">bahiaxip.com</a>

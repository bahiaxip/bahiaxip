...
class BlogController extends Controller
{
    ...
    public function blog(Request $request){
        ...
        $posts= Posts::search($request->get("search"))->orderBy("id","DESC")->where("statusint",1)->paginate(6)->appends($request->query());
        $tags = Tag::where('statusint',1)->get()->random(5);
        $rand_posts = Posts::where('statusint',1)->get()->random(4);
    ...
    public function category($slug)
    {
        ...
        $posts= Posts::where("category_id",$category)->orderBy("id","DESC")->where("statusint",1)->paginate(6);
        $tags = Tag::where('statusint',1)->get()->random(5);
        $rand_posts = Posts::where('statusint',1)->get()->random(5);
        $param = $slug;
    ...
    public function tag($slug)
    {
        ...
        ->orderBy("id","DESC")->where("statusint",1)->paginate(6);
        $tags = Tag::where('statusint',1)->get()->random(5);
        $rand_posts = Posts::where('statusint',1)->get()->random(5);
        $param = $slug;
        return view("blog.blog",compact("posts","tags","rand_posts",'param'));
